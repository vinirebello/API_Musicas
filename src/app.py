...
from api_dao import Artistas, Clientes, Generos, Gravadoras, Musicas, Planos, Musica_has_artistas, Musica_has_clientes
...
def criar_artista():
     return 'Sucesso!', Artistas.cria_artista()
...
@app.route('/musicas_has_clientes', methods=['POST'])
def insert_mhc():
    Musica_has_clientes.cria_mhc()
    return 'Musica_has_clientes criado com sucesso!'

@app.route('/musicas_has_clientes', methods=['GET'])
def select_mhc():
    return Musica_has_clientes.get_mhc()

@app.route('/musicas_has_clientes/<int:mhc_id>', methods=['GET'])
def select_mhc_id():
    return Musica_has_clientes.get_mhc_id()

@app.route('/musicas_has_clientes/<int:mhc_id>', methods=['PUT'])
def update_mhc():
    Musica_has_clientes.atualiza_mhc()
    return 'Musica_has_clientes atualizado com sucesso!'

@app.route('/musicas_has_clientes/<int:mhc_id>', methods=['DELETE'])
def delete_mhc():
    Musica_has_clientes.deleta_mhc()
    return 'Musica_has_clientes deletado com sucesso!'
